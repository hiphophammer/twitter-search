...
const AdvancedSearchForm = (props: AdvancedSearchProp) => {
  ...
  const buttonClick = () => {
    let result: string = "";
    // 일반
    if (wordRef1.current) result += wordRef1.current.value;
    // 다음 문구 그대로
    ...
    <>
      ...
      <div style={{ display: section1 ? "block" : "none" }}>
        ...
        <InputGroup className="mb-3">
          <DropdownButton title={props?.langObj?.section1_label6} id="dropdown">
      ...
      <div className="flexTitle">
        ...
        <ToggleSwitch switchStatus={section2} setSwitchStatus={setSection2} />
      </div>
      ...
      <div className="flexTitle">
        ...
        <ToggleSwitch switchStatus={section3} setSwitchStatus={setSection3} />
      </div>
      <div style={{ display: section3 ? "block" : "none" }}>
        ...
        >
          <div className="filterDivRow">
            <h6>{props?.langObj?.section3_label2}</h6>
            <Form.Check
              type="checkbox"
              id="default-radio"
          ...
          <div className="filterDivRow">
            <h6>{props?.langObj?.section3_label3}</h6>
            <Form.Check
              type="checkbox"
              id="default-radio"
              checked={!commentOption}
        ...
        >
          <div className="filterDivRow">
            <h6>{props?.langObj?.section3_label5}</h6>
            <Form.Check
              type="checkbox"
              id="default-radio"
              checked={linkOption}
          ...
          <div className="filterDivRow">
            <h6>{props?.langObj?.section3_label6}</h6>
            <Form.Check
              type="checkbox"
              id="default-radio"
              checked={!linkOption}
      ...
      <div className="flexTitle">
        ...
        <ToggleSwitch switchStatus={section4} setSwitchStatus={setSection4} />
      </div>
      ...
      <div className="flexTitle">
        ...
        <ToggleSwitch switchStatus={section5} setSwitchStatus={setSection5} />
      </div>
      ...
      <hr />
      <Button className="confirmButton" onClick={buttonClick}>
